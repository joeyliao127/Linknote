package com.penguin.linknote.domain.accesspolicies.exception;
...
@RestControllerAdvice(basePackages = "com.penguin.linknote.controller.accesspolicies")
public class AccessPoliciesExceptionHandler {
